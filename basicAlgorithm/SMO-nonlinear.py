# -*- coding: utf-8 -*-
"""
Created on Mon Mar 19 22:32:08 2018
...
x = [[1,1],[2,4],[3,12],[9,70],[5,130],[4,13],[5,29],[5,135],[4,65],[10,1000],[8,520],
     [7,340],[6,40],[10,150]]
...
tlp_x21=tlp_x10**2 + np.random.rand(100)*20-10
...
tlp_x41=tlp_x40**(round(np.random.rand(),0)+1) + np.random.rand(50)*10-5
...
for ii in range(0, len(tlp_x)):
    ...
    if ty>0:
        plt.plot(tlp_x1[ii],tlp_x2[ii],showpoint[int(ty)])
    else:
        plt.plot(tlp_x1[ii],tlp_x2[ii],showpoint[int(ty)])
plt.show()